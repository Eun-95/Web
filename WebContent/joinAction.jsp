...
<jsp:setProperty name="user" property = "userBirth1" />
<jsp:setProperty name="user" property = "userBirth2" />
...
<body>
    ...
    //null 값이 있는지 검사
        ...
        user.getUserGender()==null || user.getUserBirth()==null || user.getUserBirth1()==null || user.getUserBirth2()==null|| 
        user.getUserPhone()==null|| user.getUserPhone1()==null|| user.getUserPhone2()==null){
